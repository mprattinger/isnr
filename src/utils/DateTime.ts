...
export default class DateTime {
   ...
   * @returns DateTime
   */
  public static from(d: Date | DateTime | string): DateTime | null {
    if (!d) {
      return null;
    }
  ...
  public diff(rhs: Date | DateTime): TimeSpan {
    ...
    console.log(this as any as Date);

    const current = this as any as Date;
    const newDate = rhs as Date;

    return new TimeSpan(current.getTime() - newDate.getTime());
  }
